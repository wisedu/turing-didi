...
export default class extends DataAdapter{
    constructor() {
        ...
        let views = {
            "default": {
                "WID": {"caption": "WID","hidden": true,"groupName": "我是标题"},
                "TX": {"caption": "头像",required: true,"groupName": "我是标题",xtype:"avatar"},
                "XSBH": {"caption": "登录名",required: true,"groupName": "我是标题"},
                "XH": {"caption": "学号","readonly":true,"groupName": "我是标题"},
                "XM": {"caption": "姓名",xtype:"textarea",required: true,"groupName": "我是标题"},
                "XMPY": {"caption": "姓名拼音",required: true,"groupName": "我是标题"},
                "CYM": {"caption": "曾用名",xtype:"switcher",required: true,"groupName": "我是标题"},
                "XBDM": {"caption": "性别",xtype:"radio",options:[{id:"1",text:"女"},{id:"2",text:"男"}],params:{direction:"v"},required: true,"groupName": "我是标题"},
                "CSRQ": {"caption": "出生日期",required: true,xtype:"date-full","groupName": "我是标题"},
                //"MZDM": {"caption": "民族","groupName": "我是标题"},
                "MZDM": {"caption": "民族",xtype:"radiolist",options:[{id:"01",text:"汉"},{id:"02",text:"回"}],params:{direction:"v"}},
                "SFZJLXDM": {"caption": "身份证件类型",required: true},
                "SFZJH": {"caption": "身份证件号码",required: true},
                "JG": {"caption": "籍贯","hidden": true},
                "CSDDM": {"caption": "出生地",required: true},
                "SYDDM": {"caption": "生源地",required: true},
                "HKSZD": {"caption": "户口所在地七字",required: true},
                "GJDQDM": {"caption": "国家地区",required: true},
                "HKXZDM": {"caption": "入学前户口性质",required: true},
                "GATQDM": {"caption": "港澳台侨",required: true},
                "ZZMMDM": {"caption": "政治面貌",required: true},
                "XYZJDM": {"caption": "信仰宗教",},
                "HYZKDM": {"caption": "婚姻状态",},
                "YKTKH": {"caption": "一卡通卡号",xtype:"uploadmuiltimage"},
                "KHM": {"caption": "开户名",},
                "KKYH": {"caption": "开户行",},
                "YHZH": {"caption": "银行账号",},
                "CCQJ": {"caption": "乘车区间",},
                "JKZKDM": {"caption": "健康状况",},
                "XXDM": {"caption": "血型",},
                "TZ": {"caption": "体重（KG）",xtype:"stepper"},
                "SG": {"caption": "身高（CM）",},
                "TC": {"caption": "特长",},
                "BS": {"caption": "病史",xtype:"uploadfile"},
            ...
            "默认表单:form": {
                ...
                "group:[个人基本信息]":{
                    ...
                    items:{
                        ...
                        "XMPY": {"xtype": "textarea","dataSize": 120},
                        "CYM": {"dataSize": 120},
                        "XBDM": {xtype:"radio",options:[{id:"1",label:"女"},{id:"2",label:"男"}],params:{direction:"v"}},
                        "CSRQ": {"xtype": "date-full","dataSize": 10},
                        "MZDM": {},
